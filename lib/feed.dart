...
class Twittr extends StatelessWidget {
  ...
  Twittr({Key key, this.twts}): super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HomeScreen(twts: this.twts),
    );
  }
}
...
class HomeScreen extends StatefulWidget {
  HomeScreen({Key key, this.twts}): super(key: key);
...
//
// classs button ex stf (props)
// button -> buttonstate (build(), state manage): widget.props
//
...
class HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.twts == null || widget.twts.isEmpty) {
      print('default value.....');
      _twts = _twts2;
    } else {
      _twts = widget.twts;
